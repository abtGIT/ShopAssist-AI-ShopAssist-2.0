...
1. **Clone the repository:**
   ```
   git clone https://github.com/abtGIT/ShopAssist-AI-ShopAssist-2.0.git
   cd ShopAssist-AI-ShopAssist-2.0
   ```
2. **Lunch VS Code from Anaconda**
   - In VS Code go to `File` > `Open Folder...` and select the `ShopAssist-AI-ShopAssist-2.0` folder.
